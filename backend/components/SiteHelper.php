        ...
        $menu_items = [
            ...
            ['label' => Module::t('Content'), 'icon' => 'fa fa-navicon', 'url' => '#',
             'items' => [
                 ...
                 ['label' => Module::t('Blog categories'), 'url' => ['/content/blog-categories/index'], 'icon' => 'fa fa-circle'],
                 ['label' => Module::t('Blog posts'), 'url' => ['/content/blog-posts/index'], 'icon' => 'fa fa-circle'],
             ]
            ],
