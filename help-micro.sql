...
(14, 1503321306, 1503742599, 2, NULL, 0, 'computer-cash-systems', 1, 0, '/uploads/categories/images/4cc5898c-5f06-4c98-be73-d39438ea1a94/1.jpg');
...
(977, 'en', ''),
(977, 'ru', 'Руководство пользователя'),
(977, 'ua', 'Керівництво користувача'),
(978, 'en', ''),
(978, 'ru', 'Драйвер для USB-подключения'),
...
(118, 1503603864, 1503605041, 1, 'MG-V545T.02', NULL, 11, NULL, 'MG-V545T-02', 'simple', 1, NULL, 0, NULL, 'https://gera.com.ua/oborudovanie/kassovye-apparaty/mg-v545t.02/'),
...
(364, 117, 'en', 'MG-V545T', '', '<p>Cash register MG-V545T is a portable electronic cash register for cash and non-cash settlement with the buyer when performing settlement transactions (sales) and issuing checks for purchased goods / services.</p>\r\n<p>Designed specifically for small and medium businesses, to combine all the functions of fiscal settlement registrars with high mobility and excellent price. It is recommended to use in shops, kiosks, markets, pawn shops, pharmacies, cafes and restaurants and other places of commercial activity.</p>\r\n<p>A unique feature of the cash register MG-V545T is the ability to work with it remotely via the WEB interface using HTTP protocol. This is the only one certified device in Ukraine, which has such functionality. You no longer need to travel throughout the store network to enter data or change the product database, this can be done remotely.</p>\r\n<p>The cash register has two modifications (difference in interfaces).</p>\r\n<p>MG-V545T has interfaces RJ12-6x6 (splitter for 2 COM ports RS-232) and USB-B, allowing you to connect payment terminals, bar code scanners, USB keyboard;</p>\r\n<p>The cash register is reliable, meets modern standards, is certified by the state commission and is included in the state register of devices for settlement operations dated 07.07.2015 No. 485 by the State Fiscal Service of Ukraine.</p>\r\n<p>The function of the control tape in electronic form is implemented in the cash register MG-V545T. It allows you to instantly transmit sales reports to the State Fiscal Service of Ukraine in the form of packet data.</p>\r\n<p>Cash register MG-V545T has a keyboard for controlling the device and introducing information. The keyboard has 30 keys, 12 of which are used to enter text and numbers, and the rest are function keys.</p>\r\n<p>Main advantages:</p>\r\n<ul>\r\n<li>meets the legal requirements of 2015;</li>\r\n<li>control tape in electronic form</li>\r\n<li>has a WEB interface for remote work through the HTTP protocol, which allows you to remotely program:<br />\r\n<ul>\r\n<li>the base of goods in manual mode or import it from the file * .csv</li>\r\n<li>check cap (taxpayer attributes, tax number, fiscal number)</li>\r\n<li>tax rates</li>\r\n<li>weight barcodes</li>\r\n<li>advertising messages</li>\r\n<li>department name in the store</li>\r\n<li>name of product groups</li>\r\n<li>discounts and extra charges</li>\r\n<li>other advanced settings</li>\r\n</ul>\r\n</li>\r\n<li>printing of logos and advertising messages in the check;</li>\r\n<li>print speed of the check up to 60 millimeters per second;</li>\r\n<li>quick replacement of cash register;</li>\r\n<li>interfaces for connection to a PC, a cash drawer, a bar code scanner, a payment bank terminal;</li>\r\n<li>transfer of data to the fiscal service via the Internet.</li>\r\n</ul>', '<table class="table table-striped">\r\n<tbody>\r\n<tr>\r\n<td>Battery:</td>\r\n<td>Li-Ion, 2000 mAh</td>\r\n</tr>\r\n<tr>\r\n<td>Buyer indicator:</td>\r\n<td>No</td>\r\n</tr>\r\n<tr>\r\n<td>Channels of access to the Internet:</td>\r\n<td>option: 1 x GSM / GPRS; 1 x Wi-Fi</td>\r\n</tr>\r\n<tr>\r\n<td>Number of X reports:</td>\r\n<td>12321</td>\r\n</tr>\r\n<tr>\r\n<td>Number of Z reports:</td>\r\n<td>12321</td>\r\n</tr>\r\n<tr>\r\n<td>Number of cashiers:</td>\r\n<td>16</td>\r\n</tr>\r\n<tr>\r\n<td>Number of keys:</td>\r\n<td>30 keys</td>\r\n</tr>\r\n<tr>\r\n<td>Number of departments:</td>\r\n<td>15</td>\r\n</tr>\r\n<tr>\r\n<td>Number of characters in the product name:</td>\r\n<td>32</td>\r\n</tr>\r\n<tr>\r\n<td>Number of characters per line:</td>\r\n<td>32</td>\r\n</tr>\r\n<tr>\r\n<td>Number of goods:</td>\r\n<td>20000</td>\r\n</tr>\r\n<tr>\r\n<td>Contents of delivery:</td>\r\n<td>Cash register, power supply, user manual, passport</td>\r\n</tr>\r\n<tr>\r\n<td>Control tape:</td>\r\n<td>Control tape in the electronic form</td>\r\n</tr>\r\n<tr>\r\n<td>Maximum number of payment types:</td>\r\n<td>Cash, card, credit, check</td>\r\n</tr>\r\n<tr>\r\n<td>Printer model:</td>\r\n<td>Printer Seiko LTP01 - 245-02 (Japan)</td>\r\n</tr>\r\n<tr>\r\n<td>Tax groups with a positive result:</td>\r\n<td>5 + 1</td>\r\n</tr>\r\n<tr>\r\n<td>Connectable devices:</td>\r\n<td>Scanner, scales, PC, payment terminal</td>\r\n</tr>\r\n<tr>\r\n<td>Display type:</td>\r\n<td>Liquid crystal 128x64 (graphic)</td>\r\n</tr>\r\n<tr>\r\n<td>Colour:</td>\r\n<td>White</td>\r\n</tr>\r\n<tr>\r\n<td>Paper width:</td>\r\n<td>57,5 mm</td>\r\n</tr>\r\n<tr>\r\n<td>Print speed:</td>\r\n<td>Up to 60 mm/s</td>\r\n</tr>\r\n<tr>\r\n<td>Interfaces of connection:</td>\r\n<td>2xRS-232 (1 paired x RJ-12 (6P6C)), 1xUSB (type B)</td>\r\n</tr>\r\n<tr>\r\n<td>Max. roll diameter:</td>\r\n<td>Up to 40 mm</td>\r\n</tr>\r\n<tr>\r\n<td>Presence of an auto-cutter:</td>\r\n<td>No</td>\r\n</tr>\r\n<tr>\r\n<td>Source of power:</td>\r\n<td>220 V, 50 Hz; adapter 9 V,1 A</td>\r\n</tr>\r\n<tr>\r\n<td>Working temperature:</td>\r\n<td>+5&deg;C &hellip; +40&deg;C</td>\r\n</tr>\r\n<tr>\r\n<td>Humidity:</td>\r\n<td>from 40% to 85%</td>\r\n</tr>\r\n<tr>\r\n<td>Dimensions:</td>\r\n<td>290 x 135 x 80 mm</td>\r\n</tr>\r\n<tr>\r\n<td>Weight:</td>\r\n<td>0,81 kg</td>\r\n</tr>\r\n</tbody>\r\n</table>', '<p class="group inner list-group-item-text">Cash register MG-V545T is a portable electronic cash register for cash and non-cash settlement with the buyer when performing settlement transactions (sales) and issuing checks for purchased goods / services.</p>', '', 'CASH REGISTERS MG-V545T  BATTERY: LI-ION, 2000 MAH BUYER INDICATOR: NO CHANNELS OF ACCESS TO THE INTERNET: OPTION: 1 X GSM / GPRS; WI-FI NUMBER X REPORTS: 12321 Z CASHIERS: 16 KEYS: 30 KEYS DEPARTMENTS: 15 CHARACTERS IN PRODUCT NAME: 32 PER LINE: GOODS: 20000 CONTENTS DELIVERY: REGISTER, POWER SUPPLY, USER MANUAL, PASSPORT CONTROL TAPE: TAPE ELECTRONIC FORM MAXIMUM NUMBER PAYMENT TYPES: CASH, CARD, CREDIT, CHECK PRINTER MODEL: SEIKO LTP01 - 245-02 (JAPAN) TAX GROUPS WITH A POSITIVE RESULT: 5 + CONNECTABLE DEVICES: SCANNER, SCALES, PC, TERMINAL DISPLAY TYPE: LIQUID CRYSTAL 128X64 (GRAPHIC) COLOUR: WHITE PAPER WIDTH: 57,5 MM PRINT'),
...
(378, 121, 'ua', 'I Pos.XM', '', '<p>I Pos.XM &mdash; комп&rsquo;ютерно-касова система, яка складається з фіскального реєстратора та вбудованого Linux-комп''ютера.</p>\r\n<p>Особливості роботи системи:</p>\r\n<ul>\r\n<li>cфера застосування: торгівля, громадське харчування, сфера послуг;</li>\r\n<li>інтернет-зв''язок: Ethernet, (wi-fi опціонально);</li>\r\n<li>дисплей покупця: вбудований;</li>\r\n<li>кількість товарів: 100 000;</li>\r\n<li>вбудований модем для передачі звітності в ДПА;</li>\r\n<li>налаштування реєстратора та друк чеків через веб-інтерфейс.</li>\r\n</ul>\r\n<p>В комплекті з I Pos.XM може постачатися програма <a href="http://www.artsoft.ua/ArtSoftPortal.php" target="_blank" rel="noopener">АртСофт Портал</a>.</p>', '<table class="table table-striped">\r\n<tbody>\r\n<tr>\r\n<td>Чіпсет:</td>\r\n<td>Olimex A13/1 Ghz/512 Mb</td>\r\n</tr>\r\n<tr>\r\n<td>Операційна система:</td>\r\n<td>Linux/Android</td>\r\n</tr>\r\n<tr>\r\n<td>Сенсорний дисплей:</td>\r\n<td>8&rdquo; TFT 800x600</td>\r\n</tr>\r\n<tr>\r\n<td>Дисплей покупця:</td>\r\n<td>5&rdquo; TFT</td>\r\n</tr>\r\n<tr>\r\n<td>Кількість товарів:</td>\r\n<td>100 000</td>\r\n</tr>\r\n<tr>\r\n<td>Кількість касирів:</td>\r\n<td>16</td>\r\n</tr>\r\n<tr>\r\n<td>Кількість символів в найменуванні товару:</td>\r\n<td>46</td>\r\n</tr>\r\n<tr>\r\n<td>Види оплати:</td>\r\n<td>Готівкою, чек, платіжна карта, комбінований</td>\r\n</tr>\r\n<tr>\r\n<td>Податкові групи з позитивним підсумком:</td>\r\n<td>4</td>\r\n</tr>\r\n<tr>\r\n<td>Податкові групи з негативним підсумком:</td>\r\n<td>4</td>\r\n</tr>\r\n<tr>\r\n<td>Механізм для друку:</td>\r\n<td>Seiko</td>\r\n</tr>\r\n<tr>\r\n<td>Швидкість друку, мм/с:</td>\r\n<td>200</td>\r\n</tr>\r\n<tr>\r\n<td>Ширина стрічки, мм:</td>\r\n<td>57,5 чи 79,5</td>\r\n</tr>\r\n<tr>\r\n<td>Зовнішній діаметр рулону, мм:</td>\r\n<td>до 60</td>\r\n</tr>\r\n<tr>\r\n<td>Автоматична обрізка чеку:</td>\r\n<td>Так</td>\r\n</tr>\r\n<tr>\r\n<td>Інтерфейси:</td>\r\n<td>USB-A, RS-232, Ethernet</td>\r\n</tr>\r\n<tr>\r\n<td>Індикатор клієнта:</td>\r\n<td>вбудований</td>\r\n</tr>\r\n<tr>\r\n<td>Габаритні розміри, мм:</td>\r\n<td>180 х 150 х 180</td>\r\n</tr>\r\n<tr>\r\n<td>Вага, кг:</td>\r\n<td>1,1</td>\r\n</tr>\r\n</tbody>\r\n</table>', '<p class="group inner list-group-item-text">I Pos.XM &mdash; комп&rsquo;ютерно-касова система, яка складається з фіскального реєстратора та вбудованого Linux-комп''ютера.</p>', '', 'КОМП''ЮТЕРНО-КАСОВІ СИСТЕМИ I POS.XM  ЧІПСЕТ: OLIMEX A13/1 GHZ/512 MB ОПЕРАЦІЙНА СИСТЕМА: LINUX/ANDROID СЕНСОРНИЙ ДИСПЛЕЙ: 8&RDQUO; TFT 800X600 ДИСПЛЕЙ ПОКУПЦЯ: 5&RDQUO; КІЛЬКІСТЬ ТОВАРІВ: 100 000 КАСИРІВ: 16 СИМВОЛІВ В НАЙМЕНУВАННІ ТОВАРУ: 46 ВИДИ ОПЛАТИ: ГОТІВКОЮ, ЧЕК, ПЛАТІЖНА КАРТА, КОМБІНОВАНИЙ ПОДАТКОВІ ГРУПИ З ПОЗИТИВНИМ ПІДСУМКОМ: 4 НЕГАТИВНИМ МЕХАНІЗМ ДЛЯ ДРУКУ: SEIKO ШВИДКІСТЬ ДРУКУ, ММ/С: 200 ШИРИНА СТРІЧКИ, ММ: 57,5 ЧИ 79,5 ЗОВНІШНІЙ ДІАМЕТР РУЛОНУ, ДО 60 АВТОМАТИЧНА ОБРІЗКА ЧЕКУ: ТАК ІНТЕРФЕЙСИ: USB-A, RS-232, ETHERNET ІНДИКАТОР КЛІЄНТА: ВБУДОВАНИЙ ГАБАРИТНІ РОЗМІРИ, 180 Х 150 ВАГА, КГ: 1,1 &MDASH; КОМП&RSQUO;ЮТЕРНО-КАСОВА СИСТЕМА, ЯКА СКЛАДАЄТЬСЯ ФІСКАЛЬНОГО РЕЄСТРАТОРА ТА ВБУДОВАНОГО LINUX-КОМП''ЮТЕРА.');
...
(82, '/uploads/products/118/file/RNDIS1850.zip', 118, 1, 'Driver for Windows'),
(83, '/uploads/products/118/file/Instrukciya_obnovleniya_WEB-interfeysa_dlya_MG_N707TS_MG-V545T_MG-V545T02fab4.pdf', 118, 2, 'Instruction for web-interface update'),
(84, '/uploads/products/118/file/545-Json349f.pdf', 118, 3, 'List of commands and description of communication protocols with external devices'),
...
CREATE TABLE IF NOT EXISTS `product_gallery` (
  ...
  PRIMARY KEY (`id`),
  KEY `product_id` (`product_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1838 ;
...
(1738, '/uploads/products/118/1.jpeg', 118, NULL),
