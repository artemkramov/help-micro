...
(5, 'Контактная форма', 'Информация с контактной формы', 1, 'artemkramov@gmail.com', 'contact-form', 0);
...
(955, 'en', ''),
(955, 'ru', 'Мы разрабатываем устройства исходя из требований разных стран'),
(955, 'ua', 'Ми розробляємо пристрої виходячи з вимог різних країн'),
(956, 'en', ''),
(956, 'ru', 'Наши партнеры'),
(956, 'ua', 'Наші партнери'),
(957, 'en', 'Address: Petra Hryhorenka Avenue, 33/44, Kyiv, 02000'),
(957, 'ru', 'Адрес: проспект Петра Григоренка 33/44, Киев, 02000'),
(957, 'ua', 'Адреса: проспект Петра Григоренка 33/44, Київ, 02000'),
(958, 'en', ''),
